...
def buy():
    ...
    if request.method == "POST":
        ...
        # Ensure it is a positive integer
            ...
            return apology("Must provide a postive integer number of shares")

        # Look for the symbol the user inputted
        quote = lookup(symbol)
        if quote is None:
            return apology("Symbol not found")

        # Get the prices, shares and total cost
        price = quote["price"]
...
def history():
    ...
    # Render histiory page with transactions
...
def sell():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            ...
            return apology("Must provide a positive integer nubmer of shares")
        else:
            shares = int(shares)
